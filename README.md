This site is built using [11ty](https://www.11ty.dev/) and [tailwindcss](http://tailwindcss.com/) based on [11ty base blog](https://github.com/11ty/eleventy-base-blog)
...
2. Update the site info in `metadata.json`.
3. Update the homepage info `in data.json`.
4. Update `about.md`.
5. Go nuts :)
